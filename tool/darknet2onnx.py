...
def transform_to_onnx(cfgfile, weightfile, batch_size=1, onnx_file_name=None,channels=3):
    ...
    if dynamic:
        ...
        if not onnx_file_name:
            onnx_file_name = "yolov4_-1_{}_{}_{}_dynamic.onnx".format(channels,model.height, model.width)
        ...
        onnx_file_name = "yolov4_{}_{}_{}_{}_static.onnx".format(batch_size, channels,model.height, model.width)
        torch.onnx.export(model,
                          x,
                          onnx_file_name,
                          export_params=True,
